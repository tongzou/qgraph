...
function (_Behavior) {
  ...
  function GraphBehavior(renderer) {
    ...
    dispatcher.register(/^drag.*\.graph$/, _this.handleDrag, _assertThisInitialized(_assertThisInitialized(_this)));
    dispatcher.register(/^zoom/, _this.handleZoom, _assertThisInitialized(_assertThisInitialized(_this))); // dispatcher.register(['mousedown.graph', 'mouseenter.graph', 'mouseleave.graph'], f);
...
function (_Behavior) {
  ...
  function SelectionBehavior(renderer) {
    ...
    dispatcher.register('mousedown.*', _this.selectCell, _assertThisInitialized(_assertThisInitialized(_this)));
    dispatcher.register('mouseup.*', _this.unselectCell, _assertThisInitialized(_assertThisInitialized(_this)));
    dispatcher.register('drag*.graph', _this.handleMultiSelect, _assertThisInitialized(_assertThisInitialized(_this))); // graph.on(Graph.EVENT_TYPES.SELECTION_CHANGE, this.updateSelections, this)
...
function () {
  ...
  function EventDispatcher(root) {
    ...
    lodash__WEBPACK_IMPORTED_MODULE_0___default.a.assign(this, DEFAULTS, config);

    this.scale = 1.0;
    this.listeners = {};
    this.dragging = false;
    this.handler = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.bind(this.handleEvent, this);
  ...
  _createClass(EventDispatcher, [{
    ...
    value: function start() {
      ...
      _events__WEBPACK_IMPORTED_MODULE_1__["default"].on(this.root, 'mousedown mouseover mouseout mouseenter mouseleave dblclick click contextmenu mousewheel', this.handler);
      this.startKeys();
      this.started = true;
    }
    /**
    ...
    value: function stop() {
      if (!this.started) return;
      _events__WEBPACK_IMPORTED_MODULE_1__["default"].off(this.root, 'mousedown mouseover mouseout mouseenter mouseleave dblclick click contextmenu mousewheel', this.handler);
      this.stopKeys();
      this.started = false;
    }
  }, {
    ...
    value: function startKeys() {
      _events__WEBPACK_IMPORTED_MODULE_1__["default"].on(document, 'keydown keyup', this.handler);
    }
  }, {
    key: "stopKeys",
    value: function stopKeys() {
      _events__WEBPACK_IMPORTED_MODULE_1__["default"].off(document, 'keydown keyup', this.handler);
    }
  }, {
    key: "zoomIn",
    ...
    value: function getEventInfo(event) {
      ...
      while (!isRoot && target && target !== document) {
        ...
        if (ns) {
          isRoot = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.startsWith(ns, 'root.');
    ...
    value: function handleEvent(event) {
      ...
      /* only drag on left click */
          ...
          var mousemove = function mousemove(event) {
            ...
            if (ns === 'root') {
              dragPos = EventDispatcher.mouse(_this.root, event);
            } else {
              dragPos = currentPos;
            }
          ...
          var mouseup = function mouseup(event) {
            if (ns === 'root') {
              ...
              dragPos = _this.getPosition(event);
            }
            ...
            _events__WEBPACK_IMPORTED_MODULE_1__["default"].off(null, 'mousemove', mousemove);
            _events__WEBPACK_IMPORTED_MODULE_1__["default"].off(null, 'mouseup', mouseup);
          };

          event.preventDefault();
          _events__WEBPACK_IMPORTED_MODULE_1__["default"].on(null, 'mousemove', mousemove);
          _events__WEBPACK_IMPORTED_MODULE_1__["default"].on(null, 'mouseup', mouseup);
        }
    ...
    value: function simulateEnterLeave(event, type, ns, data, pos) {
      ...
      var getNS = function getNS(index) {
        ...
        for (var i = 0; i <= index; i++) {
          ...
          if (lodash__WEBPACK_IMPORTED_MODULE_0___default.a.startsWith(val, 'root.')) {
            val = val.substring(5);
          }
    ...
    value: function registerKey(type, key, callback, context) {
      ...
      if (lodash__WEBPACK_IMPORTED_MODULE_0___default.a.isArray(key)) {
        lodash__WEBPACK_IMPORTED_MODULE_0___default.a.forEach(key, function (k) {
    ...
    value: function register(type, callback, context, zIndex) {
      ...
      if (lodash__WEBPACK_IMPORTED_MODULE_0___default.a.isArray(type)) {
        lodash__WEBPACK_IMPORTED_MODULE_0___default.a.forEach(type, function (t) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  on: function on() {
    var el = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : typeof window !== 'undefined' ? window : null;
...
function () {
  function Link(terminalVisual) {
    ...
    lodash__WEBPACK_IMPORTED_MODULE_0___default.a.assign(this, shapeConfig);
  }
...
/* harmony import */ var _event_event_dispatcher__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./event/event-dispatcher */ "./src/event/event-dispatcher.js");
/* harmony import */ var _graph_Graph__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./graph/Graph */ "./src/graph/Graph.js");
/* harmony import */ var _graph_Cell__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./graph/Cell */ "./src/graph/Cell.js");
/* harmony import */ var _graph_Node__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./graph/Node */ "./src/graph/Node.js");
/* harmony import */ var _graph_Edge__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./graph/Edge */ "./src/graph/Edge.js");
/* harmony import */ var _layout_Layout__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./layout/Layout */ "./src/layout/Layout.js");
/* harmony import */ var _layout_FlowLayout__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./layout/FlowLayout */ "./src/layout/FlowLayout.js");
/* harmony import */ var _view_Label__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./view/Label */ "./src/view/Label.js");
/* harmony import */ var _view_Marker__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./view/Marker */ "./src/view/Marker.js");
/* harmony import */ var _view_Renderer__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./view/Renderer */ "./src/view/Renderer.js");
/* harmony import */ var _view_SVGRenderer__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./view/SVGRenderer */ "./src/view/SVGRenderer.js");
/* harmony import */ var _behavior_GraphBehavior__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./behavior/GraphBehavior */ "./src/behavior/GraphBehavior.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  EventDispatcher: _event_event_dispatcher__WEBPACK_IMPORTED_MODULE_12__["default"],
  Label: _view_Label__WEBPACK_IMPORTED_MODULE_19__["default"],
  Marker: _view_Marker__WEBPACK_IMPORTED_MODULE_20__["default"],
  Graph: _graph_Graph__WEBPACK_IMPORTED_MODULE_13__["default"],
  Cell: _graph_Cell__WEBPACK_IMPORTED_MODULE_14__["default"],
  Node: _graph_Node__WEBPACK_IMPORTED_MODULE_15__["default"],
  Edge: _graph_Edge__WEBPACK_IMPORTED_MODULE_16__["default"],
  Layout: _layout_Layout__WEBPACK_IMPORTED_MODULE_17__["default"],
  FlowLayout: _layout_FlowLayout__WEBPACK_IMPORTED_MODULE_18__["default"],
  Renderer: _view_Renderer__WEBPACK_IMPORTED_MODULE_21__["default"],
  SVGRenderer: _view_SVGRenderer__WEBPACK_IMPORTED_MODULE_22__["default"],
  GraphBehavior: _behavior_GraphBehavior__WEBPACK_IMPORTED_MODULE_23__["default"] // SelectionBehavior
...
/* harmony default export */ __webpack_exports__["default"] = ((function () {
  ...
  var editor = {
    start: function start(key, container, box, refEl, textEl) {
      ...
      if (singleLine) {
        _event_events__WEBPACK_IMPORTED_MODULE_1__["default"].on(this.input, 'keydown keyup', function (event) {
          if (event.keyCode === 13) {
            _event_events__WEBPACK_IMPORTED_MODULE_1__["default"].off(_this.input, 'keydown keyup');
      ...
      this.input.focus();
      this.input.select();
      _event_events__WEBPACK_IMPORTED_MODULE_1__["default"].fire(this, 'editor.start', [this.key]);
    },
    stop: function stop(cancel) {
      ...
      if (!cancel) {
        _event_events__WEBPACK_IMPORTED_MODULE_1__["default"].fire(this, 'editor.update', [this.key, this.input.value]);
      }

      _event_events__WEBPACK_IMPORTED_MODULE_1__["default"].fire(this, 'editor.stop', [this.key]);
      delete this.input;
      delete this.key;
      delete this.box;
      delete this.refEl;
...
function () {
  function Renderer(id, container) {
    ...
    _event_events__WEBPACK_IMPORTED_MODULE_1__["default"].on(_Label__WEBPACK_IMPORTED_MODULE_9__["default"].editor, 'editor.update.*', function (key, value) {
