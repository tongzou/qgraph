...
function (_Link4) {
  ...
  _createClass(Manhattan, [{
    ...
    */
    ...
    key: "_moveSegment2",
    value: function _moveSegment2(pts, i, d, startPadding, endPadding) {
      if (pts[i].y === pts[i + 1].y) {
        if (i > 0 && pts[i - 1].y === pts[i].y) {
          pts.splice(i + 1, 0, pts[i].clone());
          i++;
      ...
      if (this.randomNoise && pos.length > 3) {
        for (var j = 1; j < 2; j++) {
          ...
          if (this.randomNoise && pos.length == 4) {
            ...
            this._moveSegment2(pos, 1, _randomNumber, 1, 1);
          }
          ...
          if (this.randomNoise && pos.length > 4) {
            for (var _i = 1; _i < pos.length - 2; _i++) {
              ...
              this._moveSegment2(pos, _i, randomNumber, 1, 1);
            }
          }
        }
      }
